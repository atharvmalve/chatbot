...
const BotMessage = ({ content }: BotMessageProps) => {
  return (
    <div className="flex items-start mb-6 message-animation">
      ...
      <div className="max-w-[85%] md:max-w-[75%] bg-[var(--bot-message-bg)] dark:bg-[var(--bot-message-dark-bg)] rounded-2xl rounded-tl-none py-3 px-4 shadow-sm transition-all duration-300">
        <p 
          className="text-gray-800 dark:text-gray-100 text-sm md:text-base transition-colors duration-300"
